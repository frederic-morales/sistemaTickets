CREATE TYPE "public"."category" AS ENUM('hardware', 'software', 'red', 'accesos', 'otro');--> statement-breakpoint
CREATE TYPE "public"."priority" AS ENUM('critica', 'alta', 'media', 'baja');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('empleado', 'agente');--> statement-breakpoint
CREATE TYPE "public"."status" AS ENUM('abierto', 'en_progreso', 'resuelto', 'cerrado');--> statement-breakpoint
...
CREATE TABLE "tickets" (
	...
	"status" "status" DEFAULT 'abierto' NOT NULL,
